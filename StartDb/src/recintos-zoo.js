    ...
    analisaRecintos(animal, quantidade) {
        ...
        switch (animalrelacionado.nome) {
            case 'MACACO':
                ...
                //CASO DE TESTE CORRETO MAS NÃO ESTA PASSANDO COMO OBJETO, TENTEI DE VARIAS FORMAS MAS NÃO CONSEGUI
                let recintosViaveis=[`Recinto ${item.Recinto} (espaço livre: ${espaço} total: ${item.TAM})`];
